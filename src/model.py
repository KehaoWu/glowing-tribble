...
def train(args):
    ...
    with tf.Session() as sess:
        ...
        for e in range(args.epoch):
            ...
            if e % 10 == 0:
                save_path = saver.save(sess, "../var/model.ckpt")
